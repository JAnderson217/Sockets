    ...
    class Client
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                Console.WriteLine("Please Type a Valid Server IP Address and PressEnter: ");
                ...
                if (!IPAddress.TryParse(strIPAddress, out ipaddr))
{
                ...
                System.Console.WriteLine(string.Format("IPAddress: {0} - Port:{1}"
                    , ipaddr.ToString(), nPortInput));
                client.Connect(ipaddr, nPortInput);
                Console.WriteLine("Connected to the server, type text and press enter to send it " +
                    "to the srever, type < EXIT > to close.");
                ...
                while (true)
                {
                    ...
                    Encoding.ASCII.GetString(buffReceived, 0
                    , nRecv));
                }
            }
